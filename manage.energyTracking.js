...
trackedHarvest = function (creep, source) {
    ...
    if (ret == OK) {
        Memory.rooms[creep.memory.baseRoomName].energyTracking.energyTrackingPerSourceHarvested[creep.memory.targetSource] =
            Memory.rooms[creep.memory.baseRoomName].energyTracking.energyTrackingPerSourceHarvested[creep.memory.targetSource] | (0 + amount);
    }
    return ret;
};
