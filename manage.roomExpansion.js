roomExpansion = function(myRoom) {
    if (Memory.rooms[myRoom].roomExpansion != undefined) {
        if (Memory.rooms[myRoom].roomExpansion.targetRoomName != undefined) {
            ...
            // }
            console.log(`roomExpansion: ${myRoom}`)
            ...
            if (Game.rooms[targetRoomName] != undefined && Game.rooms[targetRoomName].controller.my == undefined &&
                ...
                spawnCreep(roleClaimer, "auto", {memory:{targetRoomName:targetRoomName, claim: true}}, myRoom);
                return true;
            }
            ...
            if (Game.rooms[targetRoomName].controller.level < 3) {
                ...
                if (Game.rooms[targetRoomName] != undefined && Game.rooms[targetRoomName].controller.my == true /* && Memory.rooms[targetRoomName].mainSpawn == undefined*/ &&
                    creepRoomMap.get(`${targetRoomName}harvester`) == undefined || creepRoomMap.get(`${targetRoomName}harvester`) < Memory.rooms[targetRoomName].totalMiningSpots * 3) {
                ...
                if (Game.rooms[targetRoomName] != undefined && Game.rooms[targetRoomName].controller.my == true && Memory.rooms[targetRoomName].mainSpawn == undefined &&
                    creepRoomMap.get(`${myRoom}truckerTarget${targetRoomName}`) == undefined || creepRoomMap.get(`${myRoom}truckerTarget${targetRoomName}`) < 5) {
