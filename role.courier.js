...
global.roleCourier = {
    ...
    run: function (creep) {
        ...
        if (!creep.memory.returning) {
            ...
            if (factory.store.getUsedCapacity(creep.memory.resourceType) == 0 && mainStorage.store.getUsedCapacity(creep.memory.resourceType) == 0 && terminal.store.getUsedCapacity(creep.memory.resourceType) == 0) {
